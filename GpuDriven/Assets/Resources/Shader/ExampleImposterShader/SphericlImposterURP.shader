    ...
    SubShader
    {
    	...
    	Pass
		{
			...
			VertexOutput vert ( VertexInput v )
			{
				...
				SphereImpostorVertex(_AxisFrames,_ImposterMeshFitSize,_ImposterMeshScaleAndOffset,_MeshType,_MeshCenter,_DynamicImposterId
        ...
        Pass{
            ...
            VertexOutput vert ( VertexInput v )
			{
				...
				SphereImpostorVertex(_AxisFrames,_ImposterMeshFitSize,_ImposterMeshScaleAndOffset,_MeshCenter,_MeshType,_DynamicImposterId
					,v.vertex, v.normal, o.frameUVs, o.viewPos );
								 ...
								 )
            {
				...
				half4 color;
				color.rgb = GlobalIllumination( brdfData, SampleSHPixel( IN.vertexSH, o.Normal ), o.Occlusion, o.Normal, IN.viewPos);
				color.a = o.Alpha;
