...
Shader "Scan"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			o.Emission = tex2D( _FlowEmmis, ( appendResult33 + float4( ( _Speed * _Time.y ), 0.0 , 0.0 ) ).xy ).rgb + 1E-5;
		}
...
Node;AmplifyShaderEditor.WorldPosInputsNode;32;-1184,-816;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DynamicAppendNode;33;-848,-816;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SmoothstepOpNode;16;288,704;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-528,-720;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=D91B820D32CD97DB851057CA1F08313D2F3C0E40