...
Shader "Matcap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( tex2D( _MatCap, ( ( (mul( UNITY_MATRIX_V, float4( ase_worldNormal , 0.0 ) ).xyz).xy + 1.0 ) * 0.5 ) ) * _MatCapIntensity ) * tex2D( _Diffuse, uv_Diffuse ) * tex2D( _TextureSample0, appendResult18 ) ).rgb;
			o.Alpha = 1;
		}
